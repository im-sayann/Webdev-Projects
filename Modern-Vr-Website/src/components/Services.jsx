  ...
  return (
    <main className="servicesPage">
      <main className="flex w-full px-[6rem] my-[5rem] text-white max-[850px]:flex-col max-[850px]:px-0 max-[850px]:gap-4">
        <section
          ref={scrollLeft3}
          className="flex items-center w-1/2 gap-3 max-[850px]:w-full"
        >
          <div className="leading-10 gap-4 ">
            <h2 className="font-bold text-[2.5rem] max-[850px]:text-nowrap max-[570px]:text-[2.2rem] max-[400px]:text-[1.8rem]">
              WHY BUILD
            </h2>
            <h2 className="text-[2.5rem] max-[850px]:text-nowrap max-[570px]:text-[2.2rem] max-[400px]:text-[1.8rem]">
              WITH HYDRA?
            </h2>
          </div>
      ...
      >
        {serviceData.map((item, idx) => (
          <SwiperSlide className="flex gap-4 w-full my-[5rem] text-white items-center justify-center">
            <div
              key={idx}
              className="flex flex-col justify-evenly items-center rounded-[2rem] max-w-[20rem] min-h-[33rem] px-8 py-3 gradientHomeDetails"
            >
